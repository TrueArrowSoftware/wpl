...
/**
 * Returns complete URL of given Page
 */
...
/**
 * Checks whether the person is logged in or not. If not and they are not on an admin,
 * plugin will redirects them to wp-login.php or static page
 */
function CheckLogin()
{
...
/**
 * 
 * Redirects users to the front page of the site from wp-login.php rather than going to the dashboard
 */
